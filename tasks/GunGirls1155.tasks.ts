...
const GunGirls1155Address = "0x3bE826d07A4440F2E5EA9f85CbFEF6D9c2316663"
...
task("mint", "Owner mints new token amount to address")
    ...
    .setAction(async (taskArgs, hre) => {
        const GunGirls1155Interface = await hre.ethers.getContractAt("GunGirls1155", GunGirls1155Address)
...
task("giveAdminRights", "Adds new account as a Admin")
    ...
    .setAction(async (taskArgs, hre) => {
        const GunGirls1155Interface = await hre.ethers.getContractAt("GunGirlsNFT", GunGirls1155Address)
        await GunGirls1155Interface.giveAdminRights(taskArgs.address)
...
task("revokeAdminRights", "Revoke account as a Admin")
    ...
    .setAction(async (taskArgs, hre) => {
        const GunGirls1155Interface = await hre.ethers.getContractAt("GunGirlsNFT", GunGirls1155Address)
        await GunGirls1155Interface.revokeAdminRights(taskArgs.address)
